...
$(document).ready(function() {
	$('#upload').uploadify({
		...
		auto: true,
		checkExisting: '<?php echo Router::url(array('controller'=>'file_upload','action'=>'check','plugin'=>'media'));?>',
		uploader: '<?php echo Router::url(array('controller'=>'file_upload','action'=>'upload','plugin'=>'media','dir'=>base64_encode('/test/')));?>',
		...
		removeTimeout   : 15,
		postData: <?php echo json_encode(array('dir'=> '/some/folder/')); ?>,
